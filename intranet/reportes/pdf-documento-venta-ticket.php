...
foreach ($arrayProducto as $item) {
    ...
    $pdf->Cell(10, $altura_linea, number_format($item['precio'],2), 0, 0, 'L');
...
$pdf->Cell(64, $altura_linea, "SON: " . utf8_decode($NumeroLetras->to_word($totalGeneral, "PEN")), 0, 1, 'J');

$pdf->Ln();
$pdf->MultiCell(64, $altura_linea, "Representacion Impresora de la " . $DocumentoSunat->getDescripcion() . " Electronica, esta puede ser consultada en www.casabibliachimbote.ga",0, 'J');
